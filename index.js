...
function productPopularity(p1, p2) {
  return p2.rating - p1.rating;
}

app.get('/products/sort/popularity', (req, res) => {
  let sortedProducts = products.slice();
  sortedProducts.sort(productPopularity);
  res.json({ products: sortedProducts });
});

//Endpoint 2: Get the products sorted by “high-to-low” price
function productPrice(p1, p2) {
  return p2.price - p1.price;
}

app.get('/products/sort/price-high-to-low', (req, res) => {
  let sortedProducts = products.slice();
  sortedProducts.sort(productPrice);
  res.json({ products: sortedProducts });
});

//Endpoint 3: Get the products sorted by “low-to-high” price
function sortProductsByLowToHighPrice(p1, p2) {
...
app.get('/products/filter/ram', (req, res) => {
  ...
  let sortedProducts = products.filter((prod) => filterByRam(prod, ram));
  res.json({ products: sortedProducts });
});
